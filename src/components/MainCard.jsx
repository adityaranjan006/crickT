...
const MainCard = () => {
  ...
  return (
    <div className='fixed flex flex-col justify-center w-1/2 lg:px-4 md:px-2 sm:px-1 lg:py-3 md:py-2 sm:py-1 rounded-xl rounded-tr-3xl bg-gradient-to-tr from-slate-900 via-blue-950 to-purple-900'>
